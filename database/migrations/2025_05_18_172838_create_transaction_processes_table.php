...
return new class extends Migration
{
    public function up()
    {
        Schema::connection('mysql_secondary')->create('transactions_process', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_secondary')->dropIfExists('transactions_process');
    }
};
